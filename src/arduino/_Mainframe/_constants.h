...
#define HEATING_DURATION                  40000  // ON Period (40 sec) to avoid running heating elements too hot
#define HEATING_TIMEOUT                   20000  // OFF Period (20 sec) to avoid running heating elements too hot
